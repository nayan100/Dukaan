...
- [ ] Task: Define MariaDB schema for materialized Annex 13 (Sales) and Annex 14 (Purchase) tables.
- [ ] Task: Implement Frappe `on_submit` and `on_cancel` hooks to update materialized tables in real-time.
