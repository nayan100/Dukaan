...
const AppLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/finance/sync', label: 'Sync Monitor', icon: Activity, permission: 'view_ird_monitor' },
    { path: '/finance/purchase', label: 'Purchase Register', icon: FileSpreadsheet, permission: 'view_ird_monitor' },
    { path: '/finance/audit', label: 'Audit Hub', icon: ShieldCheck, permission: 'view_ird_monitor' },
    { path: '/finance/analytics', label: 'Analytics', icon: PieChart, permission: 'view_ird_monitor' },
